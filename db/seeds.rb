...
questions = 20.times.map do
  Question.create!(
    :title => "#{Faker::Hacker.noun} #{Faker::Hacker.adjective} #{Faker::Hacker.ingverb}",
...
questions.each do |question|
  question.view_count = rand(1..300)
  random_votes = votes.sample(rand(1..300))
  random_votes.each do |vote|
    question.votes << vote
  end
end
